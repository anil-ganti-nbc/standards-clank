...
def test_deployment_known_evidence_is_admitted_deterministically():
    ...
    # M11-M17 add independently guarded Semiconductor, KTW, Tablet,
    # Feature Phone, OEM Radar, and CTW Deployment facts; the Watch
    # admission remains unchanged and is still present once.
