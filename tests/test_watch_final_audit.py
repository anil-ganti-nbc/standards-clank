...
def test_deployment_known_evidence_is_admitted_deterministically():
    ...
    # M11-M15 add independently guarded Semiconductor, KTW, Tablet,
    # Feature Phone, and OEM Radar Deployment facts; the Watch admission
    # remains unchanged and is still present once.
