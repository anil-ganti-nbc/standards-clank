...
def test_no_target_or_architecture_modification():
    ...
    for relative in tracked:
        assert relative.startswith(("standards/deployment/", "docs/deployment/", "docs/fleet-wiring.md", "docs/project-completion-audit.md", "baselines/deployment-standards-v1.0", "decisions/", "tests/", "tools/", "scripts/", "profiles/")), relative
