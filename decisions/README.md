...
Lightweight, append-only records of major Standards Clank architecture and
governance decisions — decisions about how this repository works, not
individual standards (those live in [../standards/](../standards/)).

Filename: `NNNN-short-title.md`, numbered sequentially, never renumbered or
deleted. If a decision is superseded, add a new decision that says so and
note the supersession in the old one — do not edit the old decision's
substance.
