...
> **SUPERSEDED (classification refinement, 2026-08-30).** This is the GUI
> Ratification Pass 1 conformance note, preserved verbatim as historical
> evidence. Its COM-003/004 "violation" classifications were refined to
> N/A under the standards' own conditional wording by
> [decisions/0005-qc-applicability-refinement.md](../decisions/0005-qc-applicability-refinement.md);
> the current assessment is
> [smartphone-clank-2026-08-30.md](smartphone-clank-2026-08-30.md) (the
> second, fresh-agent blind validation). The factual observations here
> were not falsified — only the classification changed. This file's
> findings block is excluded from the generated known-evidence index via
> its `superseded_by` marker.

```json
{
  "clank": "smartphone-clank",
  "date": "2026-08-30",
  "superseded_by": "audits/smartphone-clank-2026-08-30.md",
  "findings": [
